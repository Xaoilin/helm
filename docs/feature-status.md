...
| Lina activity log and undo | `real` | Chat and voice mutations create account-backed audit entries with grounded undo metadata for supported task, prayer, calendar, finance, and knowledge operations. |
