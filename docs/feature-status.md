...
| Life Hero concept approval artifact | `placeholder/simulated` | A standalone responsive character and behaviour concept exists at `concepts/life-hero/index.html`. It adds no production progression or dashboard integration, and explicit user approval is still required before LH-02. |
